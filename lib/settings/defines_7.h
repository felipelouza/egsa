...
#define BLOCK_ESA_SIZE 	(1*MB)/sizeof(t_ESA)	// (10MB) size of buffer (BLOCK_ESA_SIZE > 0)
...
#define INDUCED_SIZE 	(1*MB)/sizeof(t_INDUCED) // 8 bytes per entry 1MB //2048: size of induced buffer (16Mb) 
